...
- [4 Классы и интерфейсы](#4-классы-и-интерфейсы)
    ...
    - [4.2 Используйте в открытых классах методы доступа, а не отертые поля (Item 16)](#42-используйте-в-открытых-классах-методы-доступа-а-не-отертые-поля-item-16)
...
## 4.2 Используйте в открытых классах методы доступа, а не отертые поля (Item 16)
