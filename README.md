...
- [7 Лямбда-выражения и потоки](#7-лямбда-выражения-и-потоки)
    ...
    - [7.4 Разумно используйте потоки(stream) (Item 45)](#74-разумно-используйте-потоки--stream--item-45)
...
## 7.4 Разумно используйте потоки(stream) (Item 45)